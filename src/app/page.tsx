...
const views = [
  {
    href: "/properties",
    label: "Property View",
    description: "Ownership, permits, contractors, occupancy",
  },
  {
    href: "/tenants",
    label: "Tenant View",
    description: "Business occupancy relationships",
  },
  {
    href: "/businesses",
    label: "Business View",
    description: "Sunbiz registrations, officers, related properties",
  },
  {
    href: "/contractors",
    label: "Contractor View",
    description: "Permit history, BBB ratings, complaints, reviews",
  },
  {
    href: "/search",
    label: "Semantic Search",
    description: "Ask natural-language questions with cited sources",
  },
];
      ...
      <section className="fade-in flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div className="max-w-xl">
          ...
          <p className="mt-4 text-ink-muted">
            Every permit, contractor rating, and business filing here traces
            back to a source record — click through any card and you&apos;ll
            find the citation, not just the claim.
          </p>
        </div>
        <div className="w-full max-w-xs shrink-0 border border-line bg-paper-raised p-4 text-sm">
          ...
          <p className="text-ink-muted">
            Fort Myers &middot; Manufactured Home
          </p>
      ...
      <section>
        <div className="mb-4 flex items-center gap-3">
          ...
          <p className="text-sm text-ink-muted">
            ...
            {health.data &&
              `${health.data.status} as of ${health.data.checkedAt}`}
        ...
        <div className="grid grid-cols-1 gap-px overflow-hidden border border-line bg-line sm:grid-cols-2">
          {views.map((view) => (
            ...
            >
              <span className="font-display text-lg font-medium group-hover:underline">
                {view.label}
              </span>
